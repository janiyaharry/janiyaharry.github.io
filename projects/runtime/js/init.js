var init = function (window) {
    ...
    var background = opspark.makeBackground(app,ground); // Create a variable called background to hold the background 
    ...
    view.addChild(hud); // Add the HUD to the canvas and make it veiwable
